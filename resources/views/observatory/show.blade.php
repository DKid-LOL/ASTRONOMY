    ...
    <div class="max-w-screen-lg mx-auto py-6 px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col md:flex-row md:space-x-6 mt-6">
            ...
            <div class="mt-4 md:mt-0 md:w-2/3 space-y-4">
                ...
                <p class="text-lg"><span class="font-semibold">Website:</span> <a href="{{ $observatory->website }}"
                        class="text-blue-500 hover:text-blue-700" target="_blank">{{ $observatory->website }}</a></p>
