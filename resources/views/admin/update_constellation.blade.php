...
<body class="bg-gray-900 text-white h-screen flex flex-col">
    ...
    <div class="flex h-screen bg-gray-900 text-white">
        ...
        <div class="flex-1 p-10">
            ...
            <form action="{{ url('edit_constellation', $constellations->id) }}" method="post"
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="name" value="{{ $constellations->name }}"
                ...
                <div class="mb-4">
                    ...
                    <textarea id="description" name="description"
                        class="shadow appearance-none border rounded w-full py-2 px-3 leading-tight focus:outline-none focus:shadow-outline bg-gray-700 text-white">{{ $constellations->description }}</textarea>
                </div>

                <div class="mb-4">
                    <label class="block text-gray-400 text-sm font-bold mb-2">History</label>
                    <input type="text" name="history" value="{{ $constellations->history }}"
                        class="shadow appearance-none border rounded w-full py-2 px-3 leading-tight focus:outline-none focus:shadow-outline bg-gray-700 text-white">
                </div>

                <div class="mb-4">
                    <label class="block text-gray-400 text-sm font-bold mb-2">Mythology</label>
                    <input type="text" name="mythology" value="{{ $constellations->mythology }}"
                        class="shadow appearance-none border rounded w-full py-2 px-3 leading-tight focus:outline-none focus:shadow-outline bg-gray-700 text-white">
                </div>

                <div class="mb-4">
                    <label class="block text-gray-400 text-sm font-bold mb-2">Stars</label>
                    <input type="text" name="stars" value="{{ $constellations->stars }}"
                        class="shadow appearance-none border rounded w-full py-2 px-3 leading-tight focus:outline-none focus:shadow-outline bg-gray-700 text-white">
                </div>
