...
<body class="bg-gray-900 text-white h-screen flex flex-col">
    ...
    <div class="flex h-screen bg-gray-900 text-white">
        ...
        <div class="flex-1 p-10 overflow-auto">
            ...
            <form action="{{ url('edit_news', $news->id) }}" method="post" enctype="multipart/form-data"
                class="space-y-4">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="content"
                        class="shadow appearance-none border rounded w-full py-2 px-3 leading-tight focus:outline-none focus:shadow-outline bg-gray-700 text-white">{{ $news->content }}</textarea>
                </div>

                <div class="mb-4">
                    <label class="block text-gray-400 text-sm font-bold mb-2" for="website">Website</label>
                    <input type="text" name="website" value="{{ $news->website }}"
                        class="shadow appearance-none border rounded w-full py-2 px-3 leading-tight focus:outline-none focus:shadow-outline bg-gray-700 text-white">
                </div>

                <div class="mb-4">
                    <label class="block text-gray-400 text-sm font-bold mb-2" for="published_at">Published At</label>
                    <input type="text" name="published_at" value="{{ $news->published_at }}"
                        class="shadow appearance-none border rounded w-full py-2 px-3 leading-tight focus:outline-none focus:shadow-outline bg-gray-700 text-white">
                </div>
