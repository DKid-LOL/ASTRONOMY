        ...
        <div class="flex-1 p-10">
            ...
            <form action="{{url('upload_news')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="title" class="shadow appearance-none border rounded w-full py-2 px-3  leading-tight focus:outline-none focus:shadow-outline bg-gray-700 text-black">
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="slug" class="shadow appearance-none border rounded w-full py-2 px-3  leading-tight focus:outline-none focus:shadow-outline bg-gray-700 text-black"></input>
                </div>
                <div class="mb-4">
                    <label class="block text-gray-400 text-sm font-bold mb-2" for="description">Content</label>
                    <input type="text" name="content" class="shadow appearance-none border rounded w-full py-2 px-3  leading-tight focus:outline-none focus:shadow-outline bg-gray-700 text-black"></input>
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="pa" class="shadow appearance-none border rounded w-full py-2 px-3 leading-tight focus:outline-none focus:shadow-outline bg-gray-700 text-black"></input>
                </div>
