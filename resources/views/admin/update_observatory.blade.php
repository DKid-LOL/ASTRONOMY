...
<body class="bg-gray-900 text-white h-screen flex flex-col">
    ...
    <div class="flex h-screen bg-gray-900 text-white">
        ...
        <div class="flex-1 p-10">
            ...
            <form action="{{ url('edit_observatory', $observatories->id) }}" method="post"
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="name" value="{{ $observatories->name }}"
                ...
                <div class="mb-4">
                    ...
                    <textarea id="description" name="description"
                        class="shadow appearance-none border rounded w-full py-2 px-3 leading-tight focus:outline-none focus:shadow-outline bg-gray-700 text-white">{{ $observatories->description }}</textarea>
                </div>

                <div class="mb-4">
                    <label class="block text-gray-400 text-sm font-bold mb-2">Location</label>
                    <input type="text" name="location" value="{{ $observatories->location }}"
                        class="shadow appearance-none border rounded w-full py-2 px-3 leading-tight focus:outline-none focus:shadow-outline bg-gray-700 text-white">
                </div>

                <div class="mb-4">
                    <label class="block text-gray-400 text-sm font-bold mb-2">Latitude</label>
                    <input type="text" name="latitude" value="{{ $observatories->latitude }}"
                        class="shadow appearance-none border rounded w-full py-2 px-3 leading-tight focus:outline-none focus:shadow-outline bg-gray-700 text-white">
                </div>

                <div class="mb-4">
                    <label class="block text-gray-400 text-sm font-bold mb-2">Longitude</label>
                    <input type="text" name="longitude" value="{{ $observatories->longitude }}"
                        class="shadow appearance-none border rounded w-full py-2 px-3 leading-tight focus:outline-none focus:shadow-outline bg-gray-700 text-white">
                </div>

                <div class="mb-4">
                    <label class="block text-gray-400 text-sm font-bold mb-2">Website</label>
                    <input type="text" name="website" value="{{ $observatories->website }}"
                        class="shadow appearance-none border rounded w-full py-2 px-3 leading-tight focus:outline-none focus:shadow-outline bg-gray-700 text-white">
                </div>
