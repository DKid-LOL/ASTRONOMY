...
<body class="bg-gray-900 text-white h-screen flex flex-col">
    ...
    <div class="flex h-screen bg-gray-900 text-black">
        ...
        <div class="flex-1 p-4 overflow-auto">
            ...
            <form action="{{ url('edit_planets', $planets->id) }}" method="post" enctype="multipart/form-data"
                class="space-y-4">
                ...
                <div class="flex flex-col">
                    ...
                    <input type="text" name="name" value="{{ $planets->name }}"
                ...
                <div class="flex flex-col">
                    ...
                    <input type="number" name="diameter" value="{{ $planets->diameter }}"
                        class="p-2 bg-gray-700 text-white rounded">
                </div>

                <div class="flex flex-col">
                    <label class="mb-2 font-semibold">Atmosphere</label>
                    <input type="text" name="atmosphere" value="{{ $planets->atmosphere }}"
                        class="p-2 bg-gray-700 text-white rounded">
                </div>

                <div class="flex flex-col">
                    <label class="mb-2 font-semibold">Distance From Sun</label>
                    <input type="number" name="dfs" value="{{ $planets->distance_from_sun }}"
                        class="p-2 bg-gray-700 text-white rounded">
                </div>

                <div class="flex flex-col">
                    <label class="mb-2 font-semibold">Distance From Earth</label>
                    <input type="number" name="dfe" value="{{ $planets->distance_from_earth }}"
                        class="p-2 bg-gray-700 text-white rounded">
                </div>
