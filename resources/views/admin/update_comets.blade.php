...
<body class="bg-gray-900 text-white h-screen flex flex-col">
    ...
    <div class="flex h-screen bg-gray-900 text-white">
        ...
        <div class="flex-1 p-4 overflow-auto">
            ...
            <form action="{{ url('edit_comets', $comets->id) }}" method="post" enctype="multipart/form-data"
                class="space-y-4">
                ...
                <div class="flex flex-col">
                    ...
                    <input type="text" name="name" value="{{ $comets->name }}"
                ...
                <div class="flex flex-col">
                    ...
                    <input type="text" name="dd" value="{{ $comets->discovery_date }}"
                        class="p-2 bg-gray-700 text-white rounded">
                </div>

                <div class="flex flex-col">
                    <label class="mb-2 font-semibold">Period</label>
                    <input type="text" name="period" value="{{ $comets->period }}"
                        class="p-2 bg-gray-700 text-white rounded">
                </div>

                <div class="flex flex-col">
                    <label class="mb-2 font-semibold">Last Perihelion</label>
                    <input type="text" name="lp" value="{{ $comets->last_perihelion }}"
                        class="p-2 bg-gray-700 text-white rounded">
                </div>

                <div class="flex flex-col">
                    <label class="mb-2 font-semibold">Next Perihelion</label>
                    <input type="text" name="np" value="{{ $comets->next_perihelion }}"
                        class="p-2 bg-gray-700 text-white rounded">
                </div>
