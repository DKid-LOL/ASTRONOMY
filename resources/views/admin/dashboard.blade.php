...
<body class="bg-gray-900 text-white">
    ...
    <x-app-layout>
        ...
        <div class="flex justify-center space-x-4 p-8">
            ...
            <a href="{{ url('add_constellation') }}"
                class="bg-gray-700 hover:bg-gray-600 py-2 px-4 rounded-lg">Constellation</a>
            <a href="{{ url('add_observatory') }}"
                class="bg-gray-700 hover:bg-gray-600 py-2 px-4 rounded-lg">Observatory</a>
        ...
        <div class="flex justify-center space-x-4 p-8">
            ...
            <a href="{{ url('view_constellation') }}"
                class="bg-gray-700 hover:bg-gray-600 py-2 px-4 rounded-lg">Constellation</a>
            <a href="{{ url('view_observatory') }}"
                class="bg-gray-700 hover:bg-gray-600 py-2 px-4 rounded-lg">Observatory</a>
